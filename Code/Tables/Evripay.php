...
namespace Evripay\Payments\Evripay\Code\Tables;
 ...
 * Evripay
 *
 * @ORM\Table(name="evripay_payments_evripay", indexes={@ORM\Index(name="payment_id_index", columns={"payment_id"}), @ORM\Index(name="created_by_index", columns={"created_by"}), @ORM\Index(name="modified_by_index", columns={"modified_by"})})
 * @ORM\Entity
